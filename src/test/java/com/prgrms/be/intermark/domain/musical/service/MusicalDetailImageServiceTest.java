...
class MusicalDetailImageServiceTest {
	...
	class Save {
		...
		void saveSuccess() {
			// given
			MusicalDetailImage musicalDetailImage1 = MusicalDetailImageProvider.createMusicalDetailImage("업로드 파일1", "a",
				musical);
			MusicalDetailImage musicalDetailImage2 = MusicalDetailImageProvider.createMusicalDetailImage("업로드 파일2", "b",
				musical);
			List<MusicalDetailImage> musicalDetailImages = List.of(musicalDetailImage1, musicalDetailImage2);
			when(musicalDetailImageRepository.save(any(MusicalDetailImage.class))).thenReturn(
				any(MusicalDetailImage.class));
	...
	void deleteAllByMusicalSuccess() {
		// given
		List<MusicalDetailImage> musicalDetailImages = List.of(mock(MusicalDetailImage.class),
			mock(MusicalDetailImage.class));
