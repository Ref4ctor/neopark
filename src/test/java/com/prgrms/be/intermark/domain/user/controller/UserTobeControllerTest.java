...
// 				.build()), request, 6);
// 		PageResponseDTO<User, UserInfoResponseDTO> responseDTOPageResponseDTO = new PageResponseDTO<>(users,
// 			UserInfoResponseDTO::from, PageListIndexSize.USER_LIST_INDEX_SIZE);
// 		// when
...
// 		public void deleteUser_deactivateSelf_Success(Long userId, UserRole userRole) throws Exception {
// 			//given
...
// 					.header("Authorization", "Bearer " + "{access 토큰}")
// 					.with(csrf())
...
// 		public void deactivateUser_DiffrentUserId_Fail(Long userId, UserRole role) throws Exception {
// 			//given
...
// 							fieldWithPath("errors").type(Arrays.asList(JsonFieldType.ARRAY, JsonFieldType.NULL))
// 								.description("errors를 나타낸다."),
...
// 		public void deleteUser_AdminDeactivateDiffrentUser_Success(Long userId, UserRole role) throws Exception {
// 			//given
// 			Long targetUserId = userId + 1;
// 			String aceessToken = tokenProvider.createAceessToken(userId, role);
// 			Authentication authenticationByToken = tokenProvider.getAuthentication(aceessToken);
...
// 		public void deleteUser_AdminDeactivateAlreadyDeletedOrNotFoundUser_fail(Long userId, UserRole role) throws
// 			Exception {
// 			//given
...
// 				.with(authentication(authenticationByToken))
// 				.header("Authorization", "Bearer " + aceessToken)).andDo(print());
// 			ResultActions cannotFindUserResultActions = mockMvc.perform(
// 				delete("/api/v1/users/{targetId}", cannotFindUserId)
// 					.with(csrf())
// 					.with(authentication(authenticationByToken))
// 					.header("Authorization", "Bearer " + aceessToken)).andDo(print());
// 			//then
...
// 		public void updateRole_adminUpdateRole_success(Long userId, UserRole userRole, Long targetUserId,
// 			UserRole targetUserRole) throws Exception {
// 			//given
// 			String accessToken = tokenProvider.createAceessToken(userId, userRole);
// 			UpdateUserAuthorityRequestDTO updateUserAuthorityRequestDTO = UpdateUserAuthorityRequestDTO.builder()
// 				.authority(targetUserRole)
// 				.build();
...
// 							headerWithName("Authorization").description("Bearer + {access 토큰}")
// 						), requestFields(
// 							fieldWithPath("authority").type(JsonFieldType.STRING)
// 								.description("ROLE_USER | ROLE_SELLER | ROLE_ADMIN")
// 						)
// 					)
// 				);
...
// 		public void updateRole_adminUpdateRoleToDeletedUser_fail(Long userId, UserRole userRole, Long targetUserId,
// 			UserRole targetUserRole) throws Exception {
// 			//given
// 			String accessToken = tokenProvider.createAceessToken(userId, userRole);
// 			UpdateUserAuthorityRequestDTO updateUserAuthorityRequestDTO = UpdateUserAuthorityRequestDTO.builder()
...
// 						), responseFields(
// 							fieldWithPath("status").type(JsonFieldType.NUMBER).description("http 상태 코드"),
// 							fieldWithPath("message").type(Arrays.asList(JsonFieldType.STRING, JsonFieldType.NULL))
// 								.description("에러의 메시지"),
// 							fieldWithPath("errors").type(Arrays.asList(JsonFieldType.ARRAY, JsonFieldType.NULL))
// 								.description("errors를 나타낸다."),
// 							fieldWithPath("createdAt").type(JsonFieldType.STRING).description("언제 발생했는지를 나타낸다.")
...
// 							fieldWithPath("status").type(JsonFieldType.NUMBER).description("http 상태 코드"),
// 							fieldWithPath("message").type(JsonFieldType.STRING).description("에러의 메시지"),
// 							subsectionWithPath("errors").type(Arrays.asList(JsonFieldType.ARRAY, JsonFieldType.NULL))
// 								.description("errors를 나타낸다."),
// 							fieldWithPath("createdAt").type(JsonFieldType.STRING).description("언제 발생했는지를 나타낸다.")
// 						)
// 					)
